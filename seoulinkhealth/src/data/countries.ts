/**
 * Full country list with ISO 3166-1 alpha-2 codes and phone dial codes.
 * Used by: ApplicationFormModal, InquiryFormModal
 */
...
/** Popular countries shown first in pickers */
