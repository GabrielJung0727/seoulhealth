    ...
    <div className="admin-layout min-h-screen bg-gray-50 no-print">
      ...
      <header className="bg-white border-b-2 border-gray-100 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-brand-navy">SEOULINKHEALTH</h1>
            <p className="text-base text-gray-500">{L.loginSubtitle}</p>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          {(['applications', 'inquiries'] as Tab[]).map((t) => (
            <button
              ...
              className={`admin-btn rounded-full text-lg ${
                tab === t
            ...
            {loading && !data ? (
              ...
              items.map((item, i) => (
                <motion.button
                  ...
                  className="w-full text-left bg-white rounded-2xl border-2 border-gray-100 hover:border-brand-teal/40 hover:shadow-md p-5 lg:p-6 transition-all group"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-bold text-gray-900 group-hover:text-brand-teal transition-colors truncate">
                        {item.fullName}
                      </h3>
                      <p className="text-base text-gray-500 truncate">{item.email}</p>
