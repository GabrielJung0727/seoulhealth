...
app.use('/api/company/auth', submissionLimiter, companyAuthRouter)  // Company auth (register/login/OTP)
app.use('/api/company/qa',   adminLimiter,      qaCompanyRouter)    // Company Q&A
app.use('/api/admin/qa',     adminLimiter,      qaAdminRouter)      // Admin Q&A management
